...
*Inspired by Zara Zhang's original Follow Builders skill.*
...
A digest delivered directly into your chat with:
...
- Built-in local execution in Jules environment.
...
2. The agent fetches the feed.
3. The agent remixes the raw content into a digestible summary.
4. The digest is delivered in-chat.

## Privacy

- No API keys are sent anywhere.
