...
- **`.vibe/`**: The core "Source of Truth" for agentic intelligence and context.
  ...
  - **`skills/`**: Standardized agent skills (symlinked for all platforms).
...
All agent platforms reference the same central source of truth to ensure perfectly consistent behavior:

| Platform | Entry Point | Source File | Standard |
| :--- | :--- | :--- | :--- |
| **Universal** | `.vibe/VIBE.md` | `.vibe/VIBE.md` | Vibe Hub Protocol |
| **Gemini CLI** | `GEMINI.md` | `.vibe/VIBE.md` | [Gemini MD](https://geminicli.com/docs/cli/gemini-md/) |
| **Claude Code** | `CLAUDE.md` | `.vibe/VIBE.md` | [Claude Memory](https://code.claude.com/docs/en/memory) |
| **Codex CLI** | `AGENTS.md` | `.vibe/VIBE.md` | [Codex Agents](https://developers.openai.com/codex/guides/agents-md) |
...
4. **Compatibility**: Any new context file (`VIBE.md`) MUST be accompanied by platform-specific symlinks (`GEMINI.md`, `CLAUDE.md`, `AGENTS.md`).
