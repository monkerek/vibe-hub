...
function renderPowerline(segments: RenderedSegment[], separator: string): string {
...
function renderCompact(segments: RenderedSegment[], separator: string, maxWidth: number): string {
...
function renderExpanded(segments: RenderedSegment[], separator: string, maxWidth: number): string[] {
  const lines: string[] = [];
